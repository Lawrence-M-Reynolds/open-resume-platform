...
//        cvMarkdown = "TEST OVERRIDE";
    ...
    public enum CvTemplateDoc {
        ...
        public static CvTemplateDoc getByTemplateId(String templateId) {
            return ID_MAP.get(templateId);
        }
    }
}
